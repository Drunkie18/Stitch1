...
public class Calib3d {
    ...
    public static final int
            ...
            CALIB_DISABLE_SCHUR_COMPLEMENT = (1 << 23),
            FM_7POINT = 1,
            FM_8POINT = 2,
            FM_LMEDS = 4,
            FM_RANSAC = 8,
     ...
     * transformation. If matrix P is identity or omitted, dst will contain <b>normalized camera coordinates</b> (normalized image coordinates),
