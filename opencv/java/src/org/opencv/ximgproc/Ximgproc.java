...
public class Ximgproc {
     ...
     * @param houghPoint automatically generated
     * @param srcImgInfo automatically generated
     * @param angleRange automatically generated
     * @param makeSkew automatically generated
     * @param rules automatically generated
     * @return automatically generated
     */
    public static int[] HoughPoint2Line(Point houghPoint, Mat srcImgInfo, int angleRange, int makeSkew, int rules) {
        return HoughPoint2Line_0(houghPoint.x, houghPoint.y, srcImgInfo.nativeObj, angleRange, makeSkew, rules);
    }
    ...
    public static int[] HoughPoint2Line(Point houghPoint, Mat srcImgInfo, int angleRange, int makeSkew) {
        return HoughPoint2Line_1(houghPoint.x, houghPoint.y, srcImgInfo.nativeObj, angleRange, makeSkew);
    }
    ...
    public static int[] HoughPoint2Line(Point houghPoint, Mat srcImgInfo, int angleRange) {
        return HoughPoint2Line_2(houghPoint.x, houghPoint.y, srcImgInfo.nativeObj, angleRange);
    }
    ...
    public static int[] HoughPoint2Line(Point houghPoint, Mat srcImgInfo) {
        return HoughPoint2Line_3(houghPoint.x, houghPoint.y, srcImgInfo.nativeObj);
    }
    ...
    // C++:  Vec4i cv::ximgproc::HoughPoint2Line(Point houghPoint, Mat srcImgInfo, int angleRange = ARO_315_135, int makeSkew = HDO_DESKEW, int rules = RO_IGNORE_BORDERS)
    private static native int[] HoughPoint2Line_0(double houghPoint_x, double houghPoint_y, long srcImgInfo_nativeObj, int angleRange, int makeSkew, int rules);
    private static native int[] HoughPoint2Line_1(double houghPoint_x, double houghPoint_y, long srcImgInfo_nativeObj, int angleRange, int makeSkew);
    private static native int[] HoughPoint2Line_2(double houghPoint_x, double houghPoint_y, long srcImgInfo_nativeObj, int angleRange);
    private static native int[] HoughPoint2Line_3(double houghPoint_x, double houghPoint_y, long srcImgInfo_nativeObj);
